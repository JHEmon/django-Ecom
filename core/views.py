...
class CheckoutView(View):
    def get(self, *args, **kwargs):
        try:
            ...
            messages.info(request, "You do not have an active coupon")
            return redirect("core:checkout")
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            # yourself an email
            messages.warning(self.request, "Something went wrong. You were not charged. Please try again. Thank you !")
            return redirect("/")
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            messages.info(request,
                          "This item quantity has been updated")
            return redirect("core:order-summary")
        else:
